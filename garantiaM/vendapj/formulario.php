...
<form method="post" id="formvenda" enctype="multipart/form-data" action="/garantiaM/controller/VendaController.php?tipoCliente=<?=$tipoCliente?>">
	<div class="row">
		<div class="col-sm-8">
			<b><font size="4px"> Cliente: </font></b>
			<div class="input-group">
				<input class="form-control" class="fonte" type="text" placeholder="Pesquise o cliente pelo número do CNPJ" id="CNPJ" maxlength="14" autocomplete="off" required name="CNPJ">
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<input class="form-control" class="fonte" type="text" placeholder="Placa do carro" id="placa" name="placa" autocomplete="off" maxlength="10">
		</div>
	</div>
	...
	<div class="row">
		...
		$('button#btnPesquisar').click(function(){
			$('#inputCliente').load('procuraCliente.php?CNPJ='+$('#CNPJ').val());
		})
